...
| PUT    | `/locations/:id`         | authenticated users | Returns the updated location        |
...
**URL**: _https://where2code.herokuapp.com/api/locations/1_

**Returns**: An object with a description field.
